        ...
        <header className={styles.header}>
            ...
            <div className={`${styles.container} ${styles["menu-bottom"]}`}>
                <div className={styles["flex-space-between"]}>
                    <div className={menuOpened ? `${styles.menu} ${styles.open}` : styles.menu} id="menu-burger" onClick={showBurger}>
                        <ul className={styles["flex-space-between"]}>
                    ...
                    <div className={menuOpened ? `${styles["search-box"]} ${styles.openSearchBox}` : styles["search-box"]} >
                    ...
                    <div className={styles["menu-user"]}>
                        <div className={styles["btn-white"]}>
